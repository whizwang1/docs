...
If you already have an application you would like to deploy to the Internet Computer, you can do so easily via https://fleek.co/[Fleek], which is akin to a Netlify for the open web.

To obtain free cycles to start building on the Internet Computer, you can go to our Cycles Faucet https://faucet.dfinity.org/auth[Cycles Faucet].
